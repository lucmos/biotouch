...
# other useful labels #
GET_SHIFTED_POINTS_NAME = lambda x: "shifted_" + x
SHIFTED_MOVEMENT_POINTS = GET_SHIFTED_POINTS_NAME(MOVEMENT_POINTS)
SHIFTED_TOUCH_DOWN_POINTS = GET_SHIFTED_POINTS_NAME(TOUCH_DOWN_POINTS)
SHIFTED_TOUCH_UP_POINTS = GET_SHIFTED_POINTS_NAME(TOUCH_UP_POINTS)
SHIFTED_SAMPLED_POINTS = GET_SHIFTED_POINTS_NAME(SAMPLED_POINTS)
...
TIMED_POINTS_SERIES_TYPE = INITIAL_TIMED_POINTS_SERIES_TYPE + [SHIFTED_MOVEMENT_POINTS, SHIFTED_TOUCH_DOWN_POINTS, SHIFTED_TOUCH_UP_POINTS]
POINTS_SERIES_TYPE = TIMED_POINTS_SERIES_TYPE + [SAMPLED_POINTS, SHIFTED_SAMPLED_POINTS]
